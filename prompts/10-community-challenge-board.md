...
```text
Extend my existing Wayfinder Hub in the app folder with a Community Challenge
...
- Require STEM Journey and Data Explorer.
...
- On completion, optionally create a new Journey milestone only after the
  student confirms. Use a new stable milestone ID and source note; never mutate
  an existing milestone silently.
